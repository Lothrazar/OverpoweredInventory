...
public class IngameConfigGui extends GuiConfig {
	...
	public IngameConfigGui(GuiScreen parent) {
		super(parent, new ConfigElement(ModConfig.config.getCategory(ModConfig.categoryHighlander)).getChildElements(), Const.MODID, false, false, "Overpowered Inventory");
